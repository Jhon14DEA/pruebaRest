...
a persistence unit "ppwpruebaPersistenceUnit" which uses the JakartaEE default database.
...
In case you don't want to use JSF, simply delete this file and "src/main/webapp/beans.xml" and "src/main/java/ec/edu/ups/ppwprueba/Jsf23Activator.java"
==========================

Testing:
This sample is prepared for running unit tests with the Arquillian framework.

The configuration can be found in "ppwprueba/pom.xml":
...
artifact ("ppwprueba.war") is already built. You can build
